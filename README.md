...
then `collab menubar` (or `./scripts/install-menubar-launchagent.sh` to start it
...
| `collab menubar` | Launch the [menu bar app](docs/menubar-app.md) (needs `pip install -e ".[menubar]"`) |
